  ...
  return (
    <div className="flex flex-col h-full space-y-6 max-w-6xl mx-auto w-full p-3 pb-12 md:p-6 md:pb-12">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-white/5 border border-white/10 rounded-2xl p-4 shadow-lg backdrop-blur-md">
        ...
        <Link
          href="/dashboard"
          className="inline-flex items-center justify-center rounded-xl text-gray-400 hover:text-white text-xs sm:text-sm px-3 py-2 hover:bg-white/5 transition-colors"
        >
              ...
              return (
                ...
                >
                  ...
                  <div className="flex gap-2.5 relative z-10">
                    <Link
                      href={game.href}
                      className="flex-1 w-full py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-xl font-semibold transition-colors flex items-center justify-center gap-2 group-hover:bg-purple-600 group-hover:text-white text-sm"
                    >
