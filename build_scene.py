...
bsdf_room.inputs['Base Color'].default_value = (0.02, 0.02, 0.025, 1) # Dark cool grey
...
if char_root:
    ...
    if armature:
        ...
        def rot(name, x, y, z):
            # Try to match by suffix or exact name
            found = None
            for b in bones:
...
bpy.context.scene.render.filepath = r"C:\Users\adars\.gemini\antigravity-ide\brain\683a1177-5e32-4e70-8eb6-17015d488ffe\static_composition.png"
